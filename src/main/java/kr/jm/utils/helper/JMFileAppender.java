...
public class JMFileAppender implements AutoCloseable {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(JMFileAppender.class);
    ...
    public JMFileAppender(String filePath) {
        this(JMPath.getInstance().getPath(filePath));
    }
    ...
    public JMFileAppender(String filePath, Charset charset) {
        this(JMPath.getInstance().getPath(filePath), charset);
    }
    ...
    public JMFileAppender(Path filePath, Charset charset) {
        ...
        this.writer = JMPath.getInstance().buildBufferedAppendWriter(filePath, charset);
    ...
    public JMFileAppender append(String string) {
        JMFile.getInstance().append(this.writer, string);
        return this;
    }
    ...
    public JMFileAppender appendLine(String line) {
        JMFile.getInstance().appendLine(this.writer, line);
        return this;
    }
